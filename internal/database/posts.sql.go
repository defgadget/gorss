...
RETURNING id, created_at, updated_at, title, url, description, published_date, feed_id
`
...
SELECT posts.id, posts.created_at, posts.updated_at, posts.title, posts.url, posts.description, posts.published_date, posts.feed_id FROM posts
JOIN users_feeds
